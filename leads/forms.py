...
class LeadForm(forms.ModelForm):
    ...
    comentarios = forms.CharField(max_length=200,label=False,widget=forms.Textarea(attrs={'placeholder': 'Comentários (Opcional)','rows':5,'cols':20,'style':'resize: none'}))
    ...
    class Meta:
        model = Lead
        fields = ('nome','email','celular','comentarios','contato')